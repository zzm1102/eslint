...
describe("RuleTester", function() {
    ...
    describe("Passing objects that are not tests", function() {
        const emptyRule = {
            create() {
                return {};
            }
        ...
        it("should throw if 'valid' value is not an array or object", function() {
            assert.throws(function() {
    ...
    describe("Grouping tests into scenarios", function() {
        let describeStub,
            itStub;
        ...
        describe("for valid tests", function() {
            beforeEach(function() {
                const fakeRule = {
                    create() {
                        return {};
            ...
            it("should call describe one extra time for the scenario name", function() {
        ...
        describe("for invalid tests", function() {
            beforeEach(function() {
                const fakeRule = {
                    create(context) {
                        return {
        ...
        describe("for valid tests, nested", function() {
            beforeEach(function() {
                const fakeRule = {
                    create() {
                        return {};
            ...
            it("should call describe two extra times for the scenario names", function() {
        ...
        describe("for invalid tests, nested", function() {
            beforeEach(function() {
                const fakeRule = {
                    create(context) {
                        return {
