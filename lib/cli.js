 ...
 * @private
 */
function printResults(engine, results, format, outputFile, sourceCache) {
    let formatter;
    ...
    const output = formatter(results, sourceCache);
...
const cli = {
    ...
    execute(args, text) {
        ...
        if (currentOptions.version) { // version from package.json
            ...
            if (printResults(engine, report.results, currentOptions.format, currentOptions.outputFile, report.sourceCache)) {
